...
>
>Every [vector space](Vector%20%Space.md) has exactly one zero vector.
>
>>[!PROOF]-
>>
...
>
>For every vector $\mathbf{v} \in V$ in a [vector space](Vector%20%Space.md) $(V,F,+,\cdot)$ there is exactly one inverse vector $-\mathbf{v} \in V$ such that
>
>$$
