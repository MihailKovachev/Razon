...
>
>Let $f: D \to \mathbb{R}$ be a [real function](../../Functions%20of%20the%20Real%20Numbers.md) on a [closed interval](../../../../Set%20Theory/Ordering/Intervals.md) $D = [a;b]$.
>
...
>>$$
>>
>>The left-hand side is just the [derivative](../Differentiability.md) of $F$ at $x_0$. Since $\xi$ is between $x_0$ and $x_0 + \Delta x$, it must approach $x_0$ for $\Delta x \to 0$. This means that
>>
>>$$
