...
>
>A [complex sequence](./index.md) $\{a_n\}$ [converges](Convergence.md) to $L \in \mathbb{C}$ if and only if the [real sequences](../../Real%20Analysis/Real%20Sequences/Real%20Sequence.md) of its real and imaginary part [converge](../../Real%20Analysis/Real%20Sequences/Limits%20of%20Sequences/Convergence%20of%20Real%20Sequences.md) to the real and imaginary part of $L$, respectively.
>
>$$
