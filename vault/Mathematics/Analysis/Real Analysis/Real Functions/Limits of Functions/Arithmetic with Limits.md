...
>
>If both [limits](Limit%20of%20a%20Real%20Function.md) $\displaystyle \lim_{x \to c} f(x)$ and $\displaystyle \lim_{x \to c} g(x)$ exist for $c \in D \cup \{-\infty, +\infty\}$, then
>
...
>
>The following rules apply for the [limits](Limit%20of%20a%20Real%20Function.md) of $f$ and $g$ for $c \in D \cup \{-\infty, +\infty\}$, no matter if they are [real](Limit%20of%20a%20Real%20Function.md) or [infinite](Infinite%20Limits.md):
>
