...
>
>A [matrix](../../Matrices/Matrices.md) $A \in F^{m \times n}$ is in **row echelon form** if:
...
>>[!NOTE]
>>
>>A single [matrix](../../Matrices/Matrices.md) can possess more than a single row echelon form.
>>
>
>>[!EXAMPLE]-
>>
...
>
>A [matrix](../../Matrices/Matrices.md) $A \in F^{m \times n}$ is in **reduced row echelon form** if:
