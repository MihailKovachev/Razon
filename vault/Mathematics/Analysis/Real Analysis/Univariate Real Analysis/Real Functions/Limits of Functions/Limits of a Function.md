...
>>Let $f: D \subseteq \mathbb{R} \to \mathbb{R}$ be a [real function](../Real%20Function.md).
>>
>>The [limit](Limits%20of%20a%20Function.md) of $f$ as $x$ approaches $c \in D$ exists if and only if both [one-sided limits](One-Sided%20Limits.md) of $f$ at $c$ exist and are equal.
>>
