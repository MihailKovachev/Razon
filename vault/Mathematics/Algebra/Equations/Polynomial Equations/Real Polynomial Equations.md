...
>$$
>
>can have is equal to the [degree](../../Polynomials/Univariate%20Polynomials.md#Degree) of $A$.
>
>>[!PROOF]-
>>
>>TODO
...
>[!THEOREM] Theorem: Laguerre's Bound
>
>If the [real polynomial](../../Fields/The%20Real%20Numbers/Real%20Polynomials.md) $\sum_{k = 0}^n a_k x^k$ with $n \ge 2$ can be linearly factorized, then all roots of the [equation](./Real%20Polynomial%20Equations.md)
>
>$$
...
>$$
>
>are [[TODO|integers]] and it has a [[TODO|rational]] [root](../../Polynomials/Univariate%20Polynomials.md) $x^\ast = \frac{p}{q}$ (where $p$ and $q$ are [[TODO|coprime]]), then $p$ is a [[TODO|divisor]] of $a_0$ and $q$ is a divisor of $a_n$.
>
>>[!PROOF]-
>>
...
>$$
>
>are [[TODO|integers]] and it has a [[TODO|rational]] [root](../../Polynomials/Univariate%20Polynomials.md) $x^\ast = \frac{p}{q}$ (where $p$ and $q$ are [[TODO|coprime]]), then for every [[TODO|integer]] $m$, the [number](../../Polynomials/Univariate%20Polynomials.md#Evaluation) $A(m)$ is divisible by $p - mq$.
>
>>[!PROOF]-
>>
>>TODO
...
>
>We are given a [reciprocal polynomial equation](#Reciprocal%20Polynomial%20Equations)
>
>$$
>a_0 x^{2n} + a_1x^{2n - 1} + \cdots + a_{n-1} x^{n+1} + a_n x^n + a_{n-1} p x^{n-1} + \cdots + a_1 p^{n-1}x + a_0 p^n = 0
>$$
...
>
>Every [reciprocal polynomial equation](#Reciprocal%20Polynomial%20Equations)
>
>$$
>a_0 x^{2n + 1} + a_1 x^{2n} + \cdots + a_n x^{n+1} + a_n p x^n + a_{n-1} p^3 x^{n-1} + \cdots + a_1 p^{2n - 1}x + a_0 p^{2n+1} = 0.
>$$
...
>$$
>
>of odd degree $2n+1$ can be reduced to a [reciprocal polynomial equation](#Reciprocal%20Polynomial%20Equations) of even degree $2n$ by dividing it by $x+p$.
>
>>[!PROOF]-
>>
>>TODO
