...
Using this approximation, the [charge density](../Physics/Classical%20Electromagnetism/Electric%20Charge.md) $\rho$ inside the [space charge region](./P-N%20Junctions.md) is determined solely by the concentrations of the left-over [ions](TODO), which are fixed in place:
