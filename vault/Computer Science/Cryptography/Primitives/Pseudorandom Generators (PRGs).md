...
>
>A **generator** is an [efficient algorithm](../../Theoretical%20Computer%20Science/Algorithm%20Efficiency.md) $\operatorname{Gen}: \{0,1\}^X \to \{0,1\}^R$ where $R\gt X$ which takes a binary string as an input and produces a longer binary string as an output.
>
