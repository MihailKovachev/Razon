...
The **horizontal coordinate system** or **alt-azimuth coordinate system** is a way of locating objects on the [celestial sphere](./The%20Celestial%20Sphere.md) relative to an observer's time and location on Earth.
...
>
>The plane tangent to the Earth at the location of an observer intersects the [celestial sphere](./The%20Celestial%20Sphere.md) in a circle known as the **celestial horizon** of the observer.
>
