...
If the noun ends in *-us*, then its [[TODO|vocative]] [singular](#Number) ends in *-e*. The [[TODO|vocative]] and [[TODO|nominative]] forms of nouns ending in *-er* / *-ir* are identical . If a proper noun ends in *-ius*, then its [[TODO|vocative]] [singular](#Number) ends in *-ī* and not *-iī* (i.e. "Vergilius" becomes "Vergilī"), but the [stress](./Orthography%20(Latin).md#Stress%20Accent) remains on the same syllable as in the [[TODO|nominative]] [singular](#Number). The same applies for the words "fīlius" ("son") and "genius" ("divine guardian").
...
>[!EXAMPLE]- Example: Third Declension Nouns (Neuter)
>
><table>
...
>[!EXAMPLE]- Example: Fourth-Declension Nouns (Masculine and Feminine)
>
><table>
...
>[!EXAMPLE]- Example: Fourth Declension Nouns (Neuter)
>
><table>
