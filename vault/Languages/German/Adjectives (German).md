...
In most situations, adjectives in German must agree in gender, [case](./Syntax.md#Case%20System) and number with the [noun](./Nouns%20(German).md) they pertain to. For the most part, this is done by adding different declension endings to the adjective's canonical form.
...
- It is common to drop the *-e-* from adjectives whose canonical form ends in an unstressed *-er* preceded by a [diphthong](./Orthography%20(German).md).
...
Adjectives are used attributively a lot more often to just show that something has a given property, without putting special emphasis on this fact. In this case, adjectives are placed before the noun but after any determiners such as [articles](./Definite%20Article%20(German).md) or [Pronouns (German)](./Pronouns%20(German).md). Additionally, almost all adjectives [decline](#Declension) in order to agree in gender, [case](./Syntax.md) and number with the [noun](./Nouns%20(German).md) they pertain to. Depending on the situation, they use the different sets of endings described above.

The weak declension is used in the following cases:
- after the [definite article](./Definite%20Article%20(German).md);
- after the [demonstrative pronouns](./Pronouns%20(German).md#Demonstrative%20Pronouns) dies-, jen-, jeglich-, jed-, derselbe / dieselbe / dasselbe, derjenige / diejenige / dasjenige;
...
- after the [indefinite articles](./Definite%20Article%20(German).md) ein- and kein-;
- after [possessive pronouns](./Pronouns%20(German).md#Possessive%20Pronouns).
...
- when no [article](./Definite%20Article%20(German).md) is used with the noun;
...
>[!EXAMPLE]- Example: Attributive Adjectives and Strong Declension
>
...
The following adjectives also receive an [Umlaut](./Orthography%20(German).md) when forming the comparative base form: *alt*, *grob*, *dumm*, *arg*, *arm*, *hart*, *kalt*, *krank*, *lang*, *nah*, *scharf*, *schwach*, *schwarz*, *stark*, *warm*, *groß*, *jung*, *klug* and *kurz*. Additionally, the following adjectives may or may not receive an [Umlaut](./Orthography%20(German).md): *nass*, *bang*, *blass*, *glatt*, *karg*, *schmal*, *fromm*, *rot*, *krumm* and *gesund*. There are no other adjectives which receive an [Umlaut](./Orthography%20(German).md).
