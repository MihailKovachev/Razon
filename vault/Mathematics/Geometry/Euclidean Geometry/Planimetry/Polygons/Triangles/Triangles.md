...
>
>$$
>\begin{aligned} a + b \gt c \\ b + c \gt a \\ a + c \gt b \end{aligned}
>$$
>
...
>
>The ratios of each side in a [triangle](./Triangles.md) to the [sine](../../../../../Analysis/Real%20Analysis/Real%20Functions/Real%20Trigonometric%20Functions/Real%20Trigonometric%20Functions.md) of its opposite angle are all equal to the [diameter](../../Plane%20Curves/Circles/Circle.md) of the [circumcircle](#Properties).
>
>$$
...
>
>The side lengths $a,b,c$ of a [triangle](./Triangles.md) and the [cosines](../../../../../Analysis/Real%20Analysis/Real%20Functions/Real%20Trigonometric%20Functions/Real%20Trigonometric%20Functions.md) of the corresponding opposite angles $\alpha$, $\beta$, $\gamma$ are related as follows:
>
>$$
>\begin{aligned}
...
>>[!TIP]
>>
>>In practice, one only needs two angles and not three, since the third can always be determined using the [sum of angles theorem](#Properties).
>>
>
