...
>
>Let $S$ be a [finite](../Set%20Theory/Cardinality.md) [set](../Set%20Theory/Sets.md).
>
>A **combination** of class $k$ is a [subset](../Set%20Theory/Sets.md#Subsets) of $S$ with $k$ elements.
>
>>[!NOTE]
>>
...
>>$$
>>
>>The notation $\binom{n}{k}$ is also called a **binomial coefficient** due to its connection with the [binomial theorem](../Algebra/Fields/The%20Real%20Numbers/Real%20Polynomials.md).
>>
>
>>[!PROOF]-
>>
...
>
>If $S$ is a [set](../Set%20Theory/Sets.md) with $n$ elements, then the total number of [combinations with repetition](#Combinations%20with%20Repetition) of class $k$, denoted by $\tilde{C}_n^k$ is the total number of [combinations without elements](#Combinations%20without%20Repetition) of $(n+k-1)$ elements of class $k$.
>
>$$
