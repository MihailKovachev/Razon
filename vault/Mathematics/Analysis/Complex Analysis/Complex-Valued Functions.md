...
>
>A **complex-valued function** on a [set](../../Set%20Theory/Sets.md) $X$ is a [function](../Functions/Functions.md) $f: X \to \mathbb{C}$ from $X$ to the [complex numbers](../../Algebra/Fields/The%20Complex%20Numbers/Complex%20Numbers.md).
>
>>[!DEFINITION] Definition: Real Part
>>
>>The **real part** of $f$ is the [real-valued function](../Real%20Analysis/Real-Valued%20Functions.md) $\operatorname{Re} f: X \to \mathbb{R}$ which, for each $x \in X$, returns the [real part](../../../index.md) of $f(x)$.
>>
>>$$
...
>>
>>The **imaginary part** of $f$ is the [real-valued function](../Real%20Analysis/Real-Valued%20Functions.md) $\operatorname{Im} f: X \to \mathbb{R}$ which, for each $x \in X$, returns the [imaginary part](../../../index.md) of $f(x)$.
>>
>>$$
