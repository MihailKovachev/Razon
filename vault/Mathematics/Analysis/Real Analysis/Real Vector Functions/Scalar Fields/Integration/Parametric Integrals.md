...
>>
>>Given two [real functions](../../../Functions%20of%20the%20Real%20Numbers.md) $l,u: [a;b] \to [c;d]$, we define a **parametric integral** $\mathcal{X}: [a;b] \to \mathbb{R}$ as
>>
>>$$
...
>>>[!NOTE] Note
>>>
>>>For any particular value $x^\ast$ of $x$, the functions $l$ and $u$ result in concrete real numbers $l(x^\ast)$ and $u(x^\ast)$ and the expression $f(x^\ast, y)$ is a concrete [real function](../../../Functions%20of%20the%20Real%20Numbers.md) of $y$.
>>>
>>
>>>[!EXAMPLE]-
>>>
...
>>
>>Given two [real functions](../../../Functions%20of%20the%20Real%20Numbers.md) $l,u: [c;d] \to [a;b]$, we define a **parametric integral** $\mathcal{Y}: [c;d] \to \mathbb{R}$ as
>>
>>$$
...
>>>[!NOTE] Note
>>>
>>>For any particular value $y^\ast$ of $y$, the functions $l$ and $u$ result in concrete real numbers $l(y^\ast)$ and $u(y^\ast)$ and the expression $f(x, y^\ast)$ is a concrete [real function](../../../Functions%20of%20the%20Real%20Numbers.md) of $x$.
>>>
>>
>>>[!EXAMPLE]-
>>>
...
>Let $f: R \subset \mathbb{R}^2 \to \mathbb{R}$ be a [real scalar field](../Real%20Scalar%20Field.md) on some [rectangle](TODO) $R = [a;b] \times [c;d]$.
>
>If $f$ is [continuously partially differentiable](../Differentiation/Partial%20Derivatives%20of%20Real%20Scalar%20Fields.md) and $l,u$ are [continuously differentiable](../../../Real%20Functions/Differentiability.md), then the [derivatives](../../../Real%20Functions/Differentiability.md) of $f$'s [parametric integrals](Parametric%20Integrals.md) are given by
>
>$$
