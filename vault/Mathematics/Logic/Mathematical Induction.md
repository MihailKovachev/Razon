...
**Mathematical induction** is a proof technique which allows us to prove that a certain statement $P$ holds for every [[TODO|integer]] in some [[../Set Theory/Sets|subset]] of $\mathbb{Z}$. It is most commonly used to prove statements about the [[TODO|natural numbers]], although it can be a powerful tool for much more.
...
>
>>If there exists some $k \in \mathbb{Z}$ for which $P(k)$ is true and if $P(n)$ implies $P(n + 1)$, then $P(n)$ is true for all $n \ge k$.
>
