...
The declension patterns for nouns depending on the case are few and rather simple because German does not really rely on the noun itself to indicate the case. Instead, the case is indicated by other means like [articles](./Definite%20Article%20(German).md), [Pronouns (German)](./Pronouns%20(German).md) and [Adjectives (German)](./Adjectives%20(German).md).
...
The vast majority of feminine nouns build the plural with the ending *-(e)n*, without [Umlaut](./Orthography%20(German).md). If the noun already ends in *-e*, only *-n* is added. Otherwise, *-en* is added.
...
The second most popular pattern for the plurals of feminine nouns is the ending *-e*, accompanied by an [Umlaut](./Orthography%20(German).md) if possible. However, this pattern is *much* less common than the previous one.
...
Many neuter nouns form the plural by adding *-er*. Some nouns also receive an [Umlaut](./Orthography%20(German).md), while others do not.
...
Some neuter nouns build the plural by adding *-s*, without [Umlaut](./Orthography%20(German).md). Many of these are of foreign origin.
...
There are alao a few neuter nouns which build the plural with the ending *-(e)n*, without [Umlaut](./Orthography%20(German).md). If the noun already ends in *-e*, only *-n* is added. Otherwise, *-en* is added.
