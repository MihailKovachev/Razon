...
>
>A **general region** of in $\mathbb{R}^2$ is a [subset](../Set%20Theory/Subset.md) $D\subseteq\mathbb{R}^2$ which can be described in one of the following ways for two real numbers $a,b$ and two [continuous](../Analysis/Real%20Analysis/Real%20Functions/Continuity/Continuity%20of%20Real%20Functions.md) [real functions](../Analysis/Real%20Analysis/Real%20Functions/Real%20Function.md) $l,u: [a;b] \to \mathbb{R}$:
>
