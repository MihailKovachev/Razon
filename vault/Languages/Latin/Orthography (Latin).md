...
The [writing system](../../Linguistics/Writing%20Systems.md) of the [Latin](../../Music/Music.md) language is an [alphabet](../../Linguistics/Writing%20Systems.md#Alphabets) with a variable number of letters depending on whether one is using [Classical Latin](../../Music/Music.md) or [Ecclesiastical Latin](../../Music/Music.md).

## Classical Latin

[Classical Latin](../../Music/Music.md) employed the following [alphabet](../../Linguistics/Writing%20Systems.md#Alphabets) with 23 letters.
...
Historically, there was no distinction between lowercase and uppercase letters in [Classical Latin](../../Music/Music.md). Words were separated by **interpuncts** (`·`) instead of spaces. A sentence in [Classical Latin](../../Music/Music.md) would have thus looked something like this:
...
Additionally, long vowels were sometimes marked by an **apex** (`´`), although this was not a regular practice. When the letter `I` represented a long vowel, it was not written with an apex but was instead just written longer. A sentence in [Classical Latin](../../Music/Music.md) with long vowels marked would have thus looked something like this:
...
Nowadays, people have developed more modern conventions when writing in [Classical Latin](../../Music/Music.md) in order to make the process easier and more comprehensible, especially for educational purposes. 
...
[Ecclesiastical Latin](../../Music/Music.md) employed the following [alphabet](../../Linguistics/Writing%20Systems.md#Alphabets) with 25 letters - exactly the same as [[TODO|English]] without the letter `W w`.
...
The pronunciation of [Classical Latin](../../Music/Music.md) is very simple and predictable, since its [orthography](#Orthography) is largely phonemic, especially when the [modern conventions](#Modern%20Conventions) are obeyed.
...
The short vowels /i/, /e/, /o/, /u/ were probably pronounced with a relatively [[TODO|open]] quality and are likely to have been actualized as [ɪ], [ɛ], [ɔ], [ʊ], respectively. By contrast, the long vowels /iː/, /eː/, /oː/, /uː/ likely had a relatively [[TODO|close]] quality and were thus actualized as [iː], [eː], [oː], [uː], respectively. Occasionally, ⟨y⟩ might have been actualized as the [phone](../../Linguistics/Phonetics/Phonetics.md) [y(ː)], but most speakers probably approximated it as either /i(ː)/.

### Nasalization

Vowels were actualized as long [nasal vowels](../../Linguistics/Phonetics/Vowels.md) in before a word-final ⟨m⟩:
...
In both scenarios, the nasal consonant itself was not pronounced. Additionally, this type of lengthening is rarely indicating with [macrons](#Modern%20Conventions).
...
Since [Ecclesiastical Latin](../../Music/Music.md) never had any native speakers, it had no single pronunciation. Instead, every speaker had their own pronunciation depending on where they were from and what languages they spoke.
...
In [Ecclesiastical Latin](../../Music/Music.md), the distinction between long and short vowels is not made - all vowels are short.